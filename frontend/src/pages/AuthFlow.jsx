  ...
  return (
    <form onSubmit={submit}>
      ...
      <Field label="Full name" error={errors.name}>
        <TextInput icon={User} placeholder="John Doe" value={form.name} onChange={set("name")} error={errors.name} />
      </Field>
      <Field label="Work email" error={errors.email}>
...
let content, backTo = null;
  switch (screen) {
    ...
    case "welcome":
      content = <SuccessPanel title="Welcome back!" subtitle="You're signed in to Knowledge Gap Intelligence." actionLabel="Sign out" onAction={() => goTo("login")} />;
      break;
    default:
