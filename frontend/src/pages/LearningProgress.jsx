...
const COURSES = [
  {
    title: "Applied Cloud Security", provider: "Infosys Springboard", type: "Internal",
  ...
  {
    title: "System Design Foundations", provider: "Infosys Springboard", type: "Internal",
  ...
  {
    title: "GraphQL in Production", provider: "Infosys Springboard", type: "Internal",
...
const PLATFORMS = [
  { name: "Infosys Springboard", type: "Internal", courses: 42, color: TOKENS.primary },
