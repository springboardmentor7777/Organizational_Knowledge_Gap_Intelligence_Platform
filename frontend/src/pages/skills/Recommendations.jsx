...
function RecommendationCard({ rec }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col justify-between hover:-translate-y-1 hover:shadow-md transition-all duration-200">
...
function LearningPathCard({ path }) {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6 hover:shadow-md transition-shadow">
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">AI Learning Recommendations</h1>
      ...
      <div className="space-y-6 pt-6 border-t border-gray-200">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Personalized Learning Paths</h2>
          </div>
          <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-1.5 text-xs text-gray-500 font-medium">
              ...
              <select
                ...
                className="px-3 py-1.5 border border-gray-300 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white transition"
              >
